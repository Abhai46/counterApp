  ...
  return (
    <div className='border rounded p-5 text-center'>
        ...
        <div style={{width:'500px'}} className='d-flex justify-content-between my-5'>
            ...
            <button onClick={()=>dispatch(increment())} className='btn btn-success text-light'>Incerment</button>
        </div>
        <div className='d-flex justify-content-between'>
            ...
            <button onClick={handleIncrementAmount} className='btn btn-primary ms-3'>Incerment By Amount</button>
        </div>
    </div>
  )
}
